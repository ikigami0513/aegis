...
pub fn evaluate(_expr: &Expression, _env: SharedEnv) -> Result<Value, String> {
    todo!("V1 deprecated")
    // match expr {
...
#[allow(dead_code)]
fn validate_type(_val: &Value, _expected_type: &str) -> bool {
    todo!("V1 Deprecated")
    // match expected_type {
    //     "any" => true, // Joker
...
pub fn execute(_stmt: &Statement, _env: SharedEnv) -> Result<Option<Value>, String> {
    todo!("V1 deprecated")
...
#[allow(dead_code)]
fn execute_internal(_instr: &Instruction, _env: SharedEnv) -> Result<Option<Value>, String> {
    todo!("V1 deprecated")
    // match instr {
...
pub fn apply_func(_func_val: Value, _args: Vec<Value>, _current_env: SharedEnv) -> Result<Value, String> {
    todo!("V1 deprecated")
    // match func_val {
